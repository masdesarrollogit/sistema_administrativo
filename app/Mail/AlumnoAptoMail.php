...
class AlumnoAptoMail extends Mailable
{
    ...
    public function __construct(
        ...
        $this->cursoNombre = $grupo->accionFormativa?->denominacion_limpia
            ?? ($grupo->accionFormativa?->denominacion ?? 'tu curso');
    }
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            ...
            subject: "🎉 ¡Has aprobado {$this->cursoNombre}!",
    ...
    {
        return new Content(view: 'emails.alumno-apto');
    }
}
