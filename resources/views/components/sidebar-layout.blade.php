    ...
    <div class="w-64 bg-indigo-900 dark:bg-gray-800 text-white flex flex-col shadow-2xl relative">
        ...
        <nav class="flex-grow py-6 space-y-2">
            ...
            @hasanyrole('admin|SuperAdmin')
                ...
                <a href="{{ route('webcurso.encuestas-calidad') }}" wire:navigate
                   class="flex items-center px-6 py-3 text-indigo-100 hover:bg-indigo-800 dark:hover:bg-gray-700 transition-colors group {{ request()->routeIs('webcurso.encuestas-calidad') ? 'bg-indigo-800 dark:bg-gray-700' : '' }}">
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.196-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118L2.98 9.801c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.518-4.674z"></path></svg>
                    <span x-show="open" class="ml-4 whitespace-nowrap">Encuestas Calidad</span>
                </a>
