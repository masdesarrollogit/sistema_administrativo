...
return [
    ...
    */
    'accounts' => [
        ...
        // Cuenta que recibe los correos de Power Automate con las respuestas del
        // cuestionario de calidad (ver comando encuestas-calidad:leer-imap).
        // Gmail requiere App Password y tener IMAP habilitado en la cuenta.
        'encuestas' => [
            'host'           => env('ENCUESTA_IMAP_HOST', 'imap.gmail.com'),
            'port'           => env('ENCUESTA_IMAP_PORT', 993),
            'protocol'       => env('ENCUESTA_IMAP_PROTOCOL', 'imap'),
            'encryption'     => env('ENCUESTA_IMAP_ENCRYPTION', 'ssl'),
            'validate_cert'  => env('ENCUESTA_IMAP_VALIDATE_CERT', true),
            'username'       => env('ENCUESTA_IMAP_USERNAME', 'saldoswebcurso@gmail.com'),
            'password'       => env('ENCUESTA_IMAP_PASSWORD', ''),
            'authentication' => env('ENCUESTA_IMAP_AUTHENTICATION', null),
            'timeout'        => 30,
            'extensions'     => [],
        ],
